...
class FRNet(nn.Module):
    def __init__(self, ch_in, ch_out, ls_mid_ch=([32] * 4), out_k_size=11, k_size=3,
        ...
        for i in range(len(ls_mid_ch)):
            ...
            if ch1 != ch2:
                ...
                if cls_conv_block == RecurrentConvNeXtBlock:
                    ...
                    #module = CACPWrappedRecurrentConvNeXtBlock(ch_in=ch1,ch_out=ch_out,dim=ch_out,layer_scale_init_value=1)
                else:
